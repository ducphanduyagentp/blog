...
date: 2019-04-08T18:46:23-04:00
Tags: ["AceBear-CTF", "CTF", "reversing", "pwn", "malware-analysis", "memory-forensic"]
Language: ["English"]
---
...
![pcap-1](/img/acebear-ctf-19/pcap-1.png)
...
![anti-disassembly-1](/img/acebear-ctf-19/anti-disassembly-1.png)
...
- There are stack strings which looks like base64, but decrypting it yields no readable ascii.
    ![base64](/img/acebear-ctf-19/base64.png)
...
![procmon1](/img/acebear-ctf-19/procmon1.png)
...
![sendfile](/img/acebear-ctf-19/sendfile.png)
...
![filecount](/img/acebear-ctf-19/filecount.png)

![sentfilecount](/img/acebear-ctf-19/sentfilecount.png)
...
![send2](/img/acebear-ctf-19/send2.png)

![send1](/img/acebear-ctf-19/send1.png)
...
![decrypt1](/img/acebear-ctf-19/decrypt1.png)

![decrypt2](/img/acebear-ctf-19/decrypt2.png)

![decrypt3](/img/acebear-ctf-19/decrypt3.png)

![decrypt4](/img/acebear-ctf-19/decrypt4.png)

![ip1](/img/acebear-ctf-19/ip1.png)

![string1](/img/acebear-ctf-19/string1.png)
...
![imagebefore](/img/acebear-ctf-19/imagebefore.png)

And here's the image after fixing:

![imageafter](/img/acebear-ctf-19/imageafter.png)
